...
class ShopEngine_Archive_Products extends \ShopEngine\Base\Widget
{
	...
	protected function register_controls()
	{
		...
		*/
		...
		$this->add_control(
			...
			[
				...
				'default'      => 'yes',
				'selectors'    => [
					'{{WRAPPER}} .shopengine-archive-products :is(.shopengine-product-rating-review-count, .star-rating, .review-rating) ' => 'display: inline-flex;',
				],
			]
		);
		...
		$this->add_control(
			'shopengine_show_default_add_to_cart',
			[
				'label'        => esc_html__('Show Default Add to Cart', 'shopengine'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Show', 'shopengine'),
				'label_off'    => esc_html__('Hide', 'shopengine'),
				'return_value' => 'yes',
				'default'      => 'yes',
				'description'  => esc_html__('When Button Group is Hidden, this controls whether the plain Add to Cart button still shows.', 'shopengine'),
				'condition'    => [
		...
		$this->add_control(
			'shopengine_action_buttons_heading',
			[
				'label'     => esc_html__('Action Buttons', 'shopengine'),
		...
		$this->add_control(
			'shopengine_show_add_to_cart',
			[
				'label'        => esc_html__('Show Add to Cart', 'shopengine'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Show', 'shopengine'),
				'label_off'    => esc_html__('Hide', 'shopengine'),
				'return_value' => 'yes',
		...
		$this->add_control(
			'shopengine_add_to_cart_show_text',
			[
				'label'        => esc_html__('Show Add to Cart Text', 'shopengine'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Show', 'shopengine'),
				'label_off'    => esc_html__('Hide', 'shopengine'),
				'return_value' => 'yes',
				'default'      => 'no',
				'description'  => esc_html__('Shows the "Add to Cart" label next to the icon inside the button group.', 'shopengine'),
				'condition'    => [
					'shopengine_group_btns'       => 'yes',
					'shopengine_show_add_to_cart' => 'yes',
				],
			]
		);

		$this->add_control(
			'shopengine_add_to_cart_icon_position',
			[
				'label'     => esc_html__('Icon Position', 'shopengine'),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'before',
				'options'   => [
					'before' => esc_html__('Before Text', 'shopengine'),
					'after'  => esc_html__('After Text', 'shopengine'),
				],
				'condition' => [
					'shopengine_group_btns'             => 'yes',
					'shopengine_show_add_to_cart'       => 'yes',
					'shopengine_add_to_cart_show_text'  => 'yes',
				],
			]
		);

		$this->add_control(
			'shopengine_show_comparison',
			[
		...
		$this->add_control(
			'shopengine_show_direct_checkout',
			[
		...
		$this->add_control(
			...
			[
				'label'        => esc_html__('Show Only Add to Cart', 'shopengine'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Show', 'shopengine'),
				'label_off'    => esc_html__('Hide', 'shopengine'),
				'return_value' => 'yes',
				'default'      => 'no',
				'description' => esc_html__('Shows only Add to Cart — hides wishlist, comparison, quick view & direct checkout.', 'shopengine'),
			]
		);

		$this->add_control(
			'shopengine_independent_add_to_cart_position',
			[
				'label'        => esc_html__('Position', 'shopengine'),
				'type'         => Controls_Manager::SELECT,
				'options'      => [
					'bottom' => esc_html__('Bottom (below content)', 'shopengine'),
					'top'    => esc_html__('Top (below image)', 'shopengine'),
				],
				'default'      => 'bottom',
				'condition'    => [
					'shopengine_independent_add_to_cart' => 'yes',
				],
			]
		);
		...
		*/
		...
		$this->add_control(
			'shopengine_enable_product_info_ordering',
			[
				'label'        => esc_html__('Enable Product Info Ordering?', 'shopengine'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Yes', 'shopengine'),
				'label_off'    => esc_html__('No', 'shopengine'),
				'default'      => 'yes',
		...
		$product_info_default = [
			[
				'list_title' => esc_html__('Product Title', 'shopengine'),
				'list_key' => 'title',
			],
			[
		...
		$product_info_repeater = new Repeater();
		$this->add_control(
			'shopengine_product_info_ordering_list',
			[
				'label' => esc_html__('Product Info Order', 'shopengine'),
				'type' => Controls_Manager::REPEATER,
				'fields' => $product_info_repeater->get_controls(),
				'default' => $product_info_default,
				'title_field' => '{{{ list_title }}}',
				'item_actions' => [
					'add'       => false,
					'duplicate' => false,
				...
				'condition' => [
					'shopengine_enable_product_info_ordering' => 'yes',
				]
			]
		);
		$this->end_controls_section(); // end ./ Content Panel
		...
		[
			...
			'alpha'     => false,
			'selectors' => [
				'{{WRAPPER}} .shopengine-archive-products:not(.shopengine-archive-products--view-list) .archive-product-container'                                        => 'background-color: {{VALUE}};',
				'{{WRAPPER}} .shopengine-archive-products:not(.shopengine-archive-products--view-list) .archive-product-container .shopengine-product-description-footer' => 'background-color: {{VALUE}};',
			],
		]
		);
		...
		$this->add_control(
			'shopengine_container_hover_bg',
			[
				'label'     => esc_html__('Hover Background', 'shopengine'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .shopengine-archive-products:not(.shopengine-archive-products--view-list) .archive-product-container:hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .shopengine-archive-products:not(.shopengine-archive-products--view-list) .archive-product-container:hover .shopengine-product-description-footer' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => 'shopengine__border_hover',
				'label'    => esc_html__('Hover Border', 'shopengine'),
				...
				'fields_options' => [
					...
					'color' => [
						'label' => esc_html__('Hover Border Color', 'shopengine'),
					],
					'width' => [
						'selectors' => [
							'{{WRAPPER}} .shopengine-archive-products:not(.shopengine-archive-products--view-list) .archive-product-container:hover' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
						],
					],
				],
			]
		...
		$this->add_group_control(
			...
			[
				// Default box shadow (non-hover)
				'name'           => 'shopengine_container_box_shadow',
		...
		$this->add_group_control(
			Group_Control_Box_Shadow::get_type(),
			[
				'name'     => 'shopengine_container_box_shadow_hover',
				'label'    => esc_html__('Hover Box Shadow', 'shopengine'),
				'selector' => '{{WRAPPER}} .shopengine-archive-products:not(.shopengine-archive-products--view-list) .archive-product-container:hover',
			]
		);
        ...
        */
		...
		$this->add_control(
			'shopengine_image_customize_note',
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw'  => esc_html__('Note: You can manage the image aspect ratio and cropping from Appearance > Customize > WooCommerce > Product Images.', 'shopengine'),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .shopengine-archive-products .shopengine-archive-products__left-image .attachment-woocommerce_thumbnail' => 'height: {{SIZE}}{{UNIT}};',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .shopengine-archive-products .product .attachment-woocommerce_thumbnail' => 'width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .shopengine-archive-products .shopengine-archive-products__left-image .attachment-woocommerce_thumbnail' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition'  => ['shopengine_image_height_switch' => 'yes'],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .shopengine-archive-products .shopengine-independent-add-to-cart :is(a.button:not(.shopengine-quickview-trigger), a.added_to_cart.wc-forward)' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
					...
					'.rtl {{WRAPPER}} .shopengine-archive-products .shopengine-independent-add-to-cart :is(a.button:not(.shopengine-quickview-trigger), a.added_to_cart.wc-forward)' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}} !important;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .shopengine-archive-products .shopengine-independent-add-to-cart :is(a.button:not(.shopengine-quickview-trigger), a.added_to_cart.wc-forward)' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
					...
					'.rtl {{WRAPPER}} .shopengine-archive-products .shopengine-independent-add-to-cart :is(a.button:not(.shopengine-quickview-trigger), a.added_to_cart.wc-forward)' => 'margin: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}} !important;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .shopengine-archive-products .shopengine-independent-add-to-cart :is(a.button:not(.shopengine-quickview-trigger), a.added_to_cart.wc-forward)' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
					...
					'.rtl {{WRAPPER}} .shopengine-archive-products .shopengine-independent-add-to-cart :is(a.button:not(.shopengine-quickview-trigger), a.added_to_cart.wc-forward)' => 'border-radius: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}} !important;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .shopengine-archive-products .shopengine-independent-add-to-cart :is(a.button:not(.shopengine-quickview-trigger), a.added_to_cart.wc-forward)' => 'text-align:left;color: {{VALUE}} !important;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .shopengine-archive-products .shopengine-independent-add-to-cart :is(a.button:not(.shopengine-quickview-trigger), a.added_to_cart.wc-forward)' => 'background: {{VALUE}}  !important;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .shopengine-archive-products .shopengine-independent-add-to-cart :is(a.button:not(.shopengine-quickview-trigger), a.added_to_cart.wc-forward):hover' => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .shopengine-archive-products .shopengine-independent-add-to-cart :is(a.button:not(.shopengine-quickview-trigger), a.added_to_cart.wc-forward):hover' => 'background: {{VALUE}} !important;',
				],
			]
		);
		...
		*/
		...
		// Add to Cart has its own dedicated style controls (see the "Add to Cart
		// Button" section below), so these general Button Group controls exclude
		// it to avoid the two control sets fighting over the same element.
		$not_cart_btn = ':not(.add_to_cart_button):not(.product_type_variable):not(.product_type_grouped):not(.product_type_external)';
		...
		$this->add_control(
			'shopengine_button_group_position',
			[
				'label'   => esc_html__('Position', 'shopengine'),
				'type'    => Controls_Manager::CHOOSE,
				'options' => [
					...
					'top'    => [
						'title' => esc_html__('Top', 'shopengine'),
						'icon'  => 'eicon-v-align-top',
					],
					'left-top' => [
						'title' => esc_html__('Left Top', 'shopengine'),
						'icon'  => 'eicon-text-align-left',
					],
					'left-center' => [
						'title' => esc_html__('Left Center', 'shopengine'),
						'icon'  => 'eicon-h-align-left',
					],
					'right-top' => [
						'title' => esc_html__('Right Top', 'shopengine'),
						'icon'  => 'eicon-text-align-right',
					],
					'right-center' => [
						'title' => esc_html__('Right Center', 'shopengine'),
				...
				'selectors' => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns.loop-product--btns-pos-bottom .loop-product--btns-inner' => 'display: flex;',
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns.loop-product--btns-pos-top .loop-product--btns-inner' => 'display: flex;',
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns.loop-product--btns-pos-bottom .loop-product--btns-inner.shopengine-justify-content-center' => 'justify-content: center; display: flex;',
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns.loop-product--btns-pos-top .loop-product--btns-inner.shopengine-justify-content-center' => 'justify-content: center; display: flex;',
				],
			]
		);

		$this->add_control(
			'shopengine_button_group_always_visible',
			[
				'label'        => esc_html__('Always Visible', 'shopengine'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Yes', 'shopengine'),
				'label_off'    => esc_html__('On Hover', 'shopengine'),
				'return_value' => 'yes',
				'default'      => 'no',
				'description'  => esc_html__('Show the button group at all times instead of only on hover.', 'shopengine'),
				'prefix_class' => 'shopengine-group-btns-always-visible-',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#FFFFFF',
				'selectors' => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a, button, .button)' . $not_cart_btn       => 'background: {{VALUE}} !important;',
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a, button, .button):hover' . $not_cart_btn => 'background: {{VALUE}} !important;',
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#101010',
				'selectors' => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a:not(.shopengine-wishlist)' . $not_cart_btn . ' :is(i, span, svg, path, a::before)' => 'fill: {{VALUE}} !important; color: {{VALUE}} !important;',
					...
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a.button:not(.shopengine-quickview-trigger)' . $not_cart_btn . '::before'            => 'fill: {{VALUE}} !important; color: {{VALUE}} !important;',
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a' . $not_cart_btn . ' i'            => 'fill: {{VALUE}} !important; color: {{VALUE}} !important;',
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a:not(.wc-forward), button, .button)' . $not_cart_btn            => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#FFFFFF',
				'selectors' => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a:not(.wc-forward), button, .button)' . $not_cart_btn  => 'background: {{VALUE}} !important;',
				],
			]
		);
		$this->add_control(
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'           => 'shopengine_button_group_sbtn_border',
				'fields_options' => [
					'border'  => [
					],
					'width' => [
						...
						'selectors' => [
							'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a:not(.wc-forward), button, .button)' . $not_cart_btn => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							'.rtl {{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a:not(.wc-forward), button, .button)' . $not_cart_btn => 'border-width: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
						],
					],
					'color' => [
						'label' => esc_html__('Border Color', 'shopengine'),
				...
				'selector' => '{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a:not(.wc-forward), button, .button)' . $not_cart_btn,
			]
		);
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'           => 'shopengine_button_group_sbtn_border_hover',
				'fields_options' => [
					'border'  => [
						'label' => esc_html__('Hover Border Type', 'shopengine'),
					],
					'width' => [
						...
						'selectors' => [
							'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a:not(.wc-forward), button, .button)' . $not_cart_btn . ':hover' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							'.rtl {{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a:not(.wc-forward), button, .button)' . $not_cart_btn . ':hover' => 'border-width: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
						],
					],
					'color' => [
						'label' => esc_html__('Border Color', 'shopengine'),
				...
				'selector' => '{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a:not(.wc-forward), button, .button)' . $not_cart_btn . ':hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a.shopengine-wishlist.badge' => 'margin-left: 0px !important;',
				],
			]
		);

		$this->add_responsive_control(
			'shopengine_button_group_radius',
			[
				'label'      => esc_html__('Border Radius', 'shopengine'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a:not(.wc-forward), button, .button)' . $not_cart_btn => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
				],
			]
		);

		$this->add_responsive_control(
			'shopengine_button_group_width',
			[
				'label'      => esc_html__('Width', 'shopengine'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				...
				'selectors'  => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a:not(.wc-forward), button, .button)' . $not_cart_btn => 'width: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);

		$this->add_responsive_control(
			'shopengine_button_group_height',
			[
				'label'      => esc_html__('Height', 'shopengine'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				...
				'selectors'  => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(a:not(.wc-forward), button, .button)' => 'height: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);
		...
		/*
			----------------------------
			Add to Cart Button (styled independently from the other
			button-group icons: wishlist / quick view / comparison / direct checkout)
			----------------------------
		*/

		$this->add_control(
			'shopengine_cart_btn_heading',
			[
				'label'     => esc_html__('Add to Cart Button', 'shopengine'),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
		...
		$cart_btn_sel = 'a.add_to_cart_button, a.product_type_variable, a.product_type_grouped, a.product_type_external';

		$this->add_control(
			'shopengine_cart_btn_bg_clr',
			[
				'label'     => esc_html__('Background Color', 'shopengine'),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#FFFFFF',
				...
				'selectors' => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . ')' => 'background: {{VALUE}} !important;',
				],
			]
		);

		$this->add_control(
			'shopengine_cart_btn_hbg_clr',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . '):hover' => 'background: {{VALUE}} !important;',
				],
			]
		);

		$this->add_control(
			'shopengine_cart_btn_clr',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . ')'            => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . ')::before'    => 'color: {{VALUE}} !important; fill: {{VALUE}} !important;',
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . ') :is(i, span, svg, path)' => 'color: {{VALUE}} !important; fill: {{VALUE}} !important;',
				],
			]
		);

		$this->add_control(
			'shopengine_cart_btn_hover_clr',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . '):hover'            => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . '):hover::before'    => 'color: {{VALUE}} !important; fill: {{VALUE}} !important;',
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . '):hover :is(i, span, svg, path)' => 'color: {{VALUE}} !important; fill: {{VALUE}} !important;',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'           => 'shopengine_cart_btn_border',
				'condition'      => [
					'shopengine_show_add_to_cart' => 'yes',
				],
				'fields_options' => [
				...
				'selector' => '{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . ')',
			]
		);
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'           => 'shopengine_cart_btn_border_hover',
				'condition'      => [
					'shopengine_show_add_to_cart' => 'yes',
				],
				'fields_options' => [
				...
				'selector' => '{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . '):hover',
			]
		);

		$this->add_responsive_control(
			'shopengine_cart_btn_radius',
			[
				'label'      => esc_html__('Border Radius', 'shopengine'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%'],
				...
				'selectors'  => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . ')' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
				],
			]
		);

		$this->add_responsive_control(
			'shopengine_cart_btn_width',
			[
				'label'      => esc_html__('Width', 'shopengine'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				...
				'selectors'  => [
					'{{WRAPPER}} .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner :is(' . $cart_btn_sel . ')' => 'width: {{SIZE}}{{UNIT}} !important; flex: none;',
				],
			]
		);
	...
	/**
	 * Returns CSS hide classes based on per-button visibility settings.
	 * Used by show_product_action_btns() and render_footer_action_btns().
	 */
	private function get_button_hide_classes()
	{
		$settings = $this->get_settings_for_display();
		$classes  = [];
		if (($settings['shopengine_show_wishlist'] ?? 'yes') !== 'yes')        $classes[] = 'se-hide-wishlist';
		if (($settings['shopengine_show_quickview'] ?? 'yes') !== 'yes')       $classes[] = 'se-hide-quickview';
		if (($settings['shopengine_show_add_to_cart'] ?? 'yes') !== 'yes')     $classes[] = 'se-hide-add-to-cart';
		if (($settings['shopengine_show_comparison'] ?? 'yes') !== 'yes')      $classes[] = 'se-hide-comparison';
		if (($settings['shopengine_show_direct_checkout'] ?? 'yes') !== 'yes') $classes[] = 'se-hide-direct-checkout';
		if (($settings['shopengine_add_to_cart_show_text'] ?? 'no') === 'yes') {
			$classes[] = 'se-cart-show-text';
			$icon_position = $settings['shopengine_add_to_cart_icon_position'] ?? 'before';
			$classes[] = 'se-cart-icon-' . sanitize_html_class($icon_position);
		}
		return implode(' ', $classes);
	}

	/**
	 * Renders footer action buttons (non-group-btn context).
	 * Per-button visibility is handled by CSS hide classes on the wrapper.
	 * Visual order is controlled via generate_order_item_css() CSS.
	 */
	public function render_footer_action_btns()
	{
	 ...
	 */
	public function open_product_thumb_wrap()
	{
		$settings = $this->get_settings_for_display();
		$position = $settings['shopengine_button_group_position'] ?? 'bottom';
		if ($position === 'left') $position = 'left-center';
		if ($position === 'right') $position = 'right-center';
		if (!in_array($position, ['bottom', 'top', 'left-top', 'left-center', 'right-top', 'right-center'], true)) {
			$position = 'bottom';
		}

		echo '<div class="shopengine-product-thumb-wrap shopengine-thumb-wrap-pos-' . sanitize_html_class($position) . '">';
	}
	...
	public function show_product_action_btns()
	{
		...
		$hide_classes = $this->get_button_hide_classes();

		woocommerce_template_loop_product_link_close();
		?>
		<div class="loop-product--btns loop-product--btns-pos-<?php echo sanitize_html_class($position); ?> <?php echo esc_attr($hide_classes); ?>" <?php echo esc_attr($data_attr); ?>>
			<div class="loop-product--btns-inner shopengine-justify-content-center">
	...
	public function show_empty_product_rating($html, $ratings, $count)
	{
		...
		return '<div class="woocommerce-product-rating">' . $html . '<span class="shopengine-product-rating-review-count">(' . $review_count . ')</span></div>';
	}
	...
	private function generate_product_info_order_css($order_items)
	{
		$parent = '.elementor-element-' . $this->get_id() . ' .shopengine-archive-products';

		$styles  = $parent . ' .product a.woocommerce-LoopProduct-link { display: flex !important; flex-direction: column; }';
		$styles .= $parent . ' .product .shopengine-product-description-footer { order: 999; }';

		foreach ($order_items as $key => $item) {
			$order_number = $key + 1;
			switch ($item['list_key']) {
				case 'title':
					$styles .= $parent . ' .product .woocommerce-loop-product__title { order: ' . $order_number . '; }';
					break;
				case 'price':
					$styles .= $parent . ' .product .price { order: ' . $order_number . '; }';
					break;
				case 'rating':
					$styles .= $parent . ' .product .woocommerce-product-rating { order: ' . $order_number . '; }';
					break;
			}
		}
	...
	/**
	 * Overrides the icon-only add-to-cart button styles so the "Add to Cart"
	 * text can render alongside the icon, with the icon placed before/after it.
	 */
	private function generate_add_to_cart_text_css()
	{
		$parent = '.elementor-element-' . $this->get_id() . ' .shopengine-archive-products';
		$cart_btns = 'a.add_to_cart_button, a.product_type_variable, a.product_type_grouped, a.product_type_external';

		$styles  = $parent . ' ul li .loop-product--btns.se-cart-show-text .loop-product--btns-inner :is(' . $cart_btns . ') {';
		$styles .= 'font-size: 13px !important; width: auto !important; height: auto !important; display: inline-flex !important; align-items: center; justify-content: center; white-space: nowrap;';
		$styles .= '}';

		$styles .= $parent . ' ul li .loop-product--btns.se-cart-show-text .loop-product--btns-inner :is(' . $cart_btns . ')::before {';
		$styles .= 'margin-right: 6px;';
		$styles .= '}';

		$styles .= $parent . ' ul li .loop-product--btns.se-cart-icon-after .loop-product--btns-inner :is(' . $cart_btns . ')::before {';
		$styles .= 'order: 1; margin-right: 0; margin-left: 6px;';
		$styles .= '}';

		$styles .= $parent . ' ul li .loop-product--btns.se-cart-show-text .loop-product--btns-inner {';
		$styles .= 'grid-template-columns: repeat(auto-fit, minmax(30px, max-content));';
		$styles .= '}';
	...
	protected function screen()
	{
		...
		if (($shopengine_enable_product_info_ordering ?? '') === 'yes' && !empty($shopengine_product_info_ordering_list)) {
			$this->generate_product_info_order_css($shopengine_product_info_ordering_list);
		}

		if ($shopengine_group_btns === 'yes' && ($shopengine_add_to_cart_show_text ?? 'no') === 'yes') {
			$this->generate_add_to_cart_text_css();
		}
		...
		if ($shopengine_group_btns === 'yes') {
			...
			add_action('woocommerce_before_shop_loop_item', [$this, 'open_product_thumb_wrap'], 9);
		...
		if ($shopengine_group_btns === 'yes') {
			...
			remove_action('woocommerce_before_shop_loop_item', [$this, 'open_product_thumb_wrap'], 9);
		}
